...
surgery-ui-window-steps-error-armor = Musisz zdjąć pancerz pacjenta!
...
surgery-blocked-bone = Wymaga: Napraw kości
surgery-blocked-organ = Wymaga: Ulecz narządy
surgery-blocked-dismemberment = Wymaga: Usuń pozostałości amputacji
surgery-blocked-bleeding = Wymaga: zatamowania krwawienia
surgery-blocked-generic = Zablokowane przez nieleczony uraz
