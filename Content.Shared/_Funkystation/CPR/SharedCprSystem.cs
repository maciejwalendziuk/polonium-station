...
public abstract partial class SharedCprSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        // Subs.CVar auto-unsubscribes on system shutdown, unlike raw _config.OnValueChanged (which would leak
        // a handler capturing this system every round restart).
        Subs.CVar(_config, CprCVars.Repeat, value => _cprRepeat = value, true);
        Subs.CVar(_config, CprCVars.ReviveChance, value => _cprReviveChance = value, true);
        Subs.CVar(_config, CprCVars.AirlossHealAmount, value => _cprAirlossHealAmount = value, true);
        Subs.CVar(_config, CprCVars.DoAfterDelay, value => _cprDoAfterDelay = value, true);
        Subs.CVar(_config, CprCVars.RibCrackPump, value => _cprRibCrackPump = value, true);
        Subs.CVar(_config, CprCVars.RibCrackDamage, value => _cprRibCrackDamage = value, true);
